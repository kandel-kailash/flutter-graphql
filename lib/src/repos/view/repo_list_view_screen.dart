...
import 'package:github_graphql_app/src/repos/view/widgets/custom_app_bar.dart';
import 'package:github_graphql_app/src/repos/view/widgets/repo_tile.dart';
          ...
          (index) => FadeTransition(
            ...
            child: Text(
              ...
              style: const TextStyle(
                fontSize: 32,
                shadows: [
                  Shadow(color: Colors.blueGrey, offset: Offset(-1, -1)),
                ],
                color: Colors.black,
              ),
            ),
