...
import 'package:github_graphql_app/src/auth/services/credentials_storage/credentials_storage.dart';
...
class GithubAuthenticator {
  GithubAuthenticator(this._dio, this._credentialsStorage);
  ...
  static Uri get redirectUri => Uri.parse(
    kIsWeb
        ? '${web.window.location.origin}/#${AppRouteConfig.splash.path}'
        : redirectUrl,
  );
  ...
  Future<Either<AuthFailure, Unit>> signOut() async {
    ...
    final encodedCredentials = stringToBase64.encode(
