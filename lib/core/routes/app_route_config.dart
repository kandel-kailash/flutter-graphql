...
import 'package:github_graphql_app/src/auth/view/auth_screen.dart';
import 'package:github_graphql_app/src/auth/view/welcome_screen.dart';
import 'package:github_graphql_app/src/repos/services/graphql_config.dart';
import 'package:github_graphql_app/src/repos/services/user_info_storage.dart';
import 'package:github_graphql_app/src/repos/view/repo_details_view.dart';
import 'package:github_graphql_app/src/repos/view/repo_list_view_screen.dart';
import 'package:github_graphql_app/src/repos/view_modal/list_view_cubit.dart';
import 'package:github_graphql_app/src/repos/view_modal/search_view_cubit.dart';
...
enum AppRouteConfig {
  ...
  details('/details/:repoName', name: 'details');

  const AppRouteConfig(this.path, {required this.name});
  ...
  static final List<RouteBase> _routes = values.map((route) {
    return switch (route) {
          ...
          return ListenableBuilder(
            ...
            child: RepositoryProvider<LoginUserStorage>(
              ...
              child: MultiBlocProvider(
                ...
                child: RepoListView.responsive(context: context, child: child),
              ),
            ),
          );
        },
  ...
  static GoRouter get router =>
      GoRouter(navigatorKey: rootNavigatorKey, routes: _routes);
}
